...
namespace Web.Services.Concrete
{
    public class CategoryService : ICategoryService
    {
        ...
        public async Task<bool> CreateAsync(CategoryCreateVM model)
        {
            ...
            if (isExist)
            {
                _modelState.AddModelError("Title", "Bu adda artiq kateqoriya var");
                return false;
            }
        ...
        //public Task<CategoryUpdateVM> GetAsync(int id)
        //{
        //    throw new NotImplementedException();
        //}

        //Task ICategoryService.CreateAsync(CategoryCreateVM model)
        //{
        //    throw new NotImplementedException();
        //}

        //Task ICategoryService.UpdateAsync(CategoryUpdateVM model)
        //{
        //    throw new NotImplementedException();
        //}
    }
